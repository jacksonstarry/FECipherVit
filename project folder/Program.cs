    ...
    static class Program
    {
        ...
        static void Main()
        {
            try
            {
                ...
                Application.Run(new FECipherVit());
            }
            catch (Exception ex)
            {
                string str = "";
        ...
        static void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            //frmBug f = new frmBug(str);//友好提示界面
            //f.ShowDialog();
            MessageBox.Show("程序出现致命错误，请将ErrLog文件夹下的ErrLog.txt文件发送给作者，谢谢合作！" + Environment.NewLine + "如果可能，请您立刻导出战报与场面信息。", "错误", MessageBoxButtons.OK);
        }
        /// <summary>
        /// 写文件
        /// </summary>
